...
export const addParamsToTableItem = (table: JsonConfigTable[]): (JsonConfigTable & { oldTimestamp?: number })[] => {
    const tableWithMoreParams: (JsonConfigTable & { oldTimestamp?: number })[] = table;
